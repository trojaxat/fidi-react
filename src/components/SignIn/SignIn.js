...
class SignIn extends React.Component {
    ...
    render() {
        return (
        <div className="br2 ba bw2 dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 bg-light-purple center">
        <div className="pa4 black-80">
          <div className="measure center">
            <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
              <legend className="f4 br2 fw6 ph0 mh0">Sign In</legend>
              <div className="mt3">
              ...
              <div className="mv3">
                ...
                <input 
                    className="b br2 pa2 input-reset ba bg-light-blue hover-bg-blue hover-white w-100" 
                    type="password" 
                    name="password" 
                    id="password"
            ...
            <div className="lh-copy mt3">
              <p 
                ...
                className="f6 hover-cadetblue black db pointer grow">Register</p>
            </div>
          </div>
        </div>
        </div>
